    ...
    <div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{display: 'flex', flexWrap:'wrap' }}>    
            <TextField id="email" label="Email" variant="outlined" value={employee.email||''} onChange={(e)=>{
                setEmployee(prev => ({...prev, email:e.target.value}))
            }} sx={{width:"100%", margin:"8px 0"}}/>
            
            <TextField id="username" label="Username" variant="outlined" value={employee.username||''} onChange={(e)=>{
